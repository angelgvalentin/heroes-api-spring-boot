INSERT INTO heroes (id, secret_identity, hero_name, team_name) VALUES
  (1, 'Clark Kent', 'Superman', 'Justice League'),
  (2, 'Bruce Wayne', 'Batman', 'Justice League'),
  (3, 'Diana Prince', 'Wonder Woman', 'Justice League'),
